<x-guest-layout>
        ...
        <nav class="bg-[#243668] flex justify-center lg:justify-start items-center">
            ...
            <div class="block lg:hidden w-1/6 z-[1500]">
                ...
                <ul class="mobile-links hidden w-full absolute z-50 left-0 mt-2 pt-4 text-center bg-[#243668]">
                    ...
                    <li><a href="#Fotos" class="link">Fotos</a></li>
                    <li><a href="#Contacto" class="link mb-4">Contacto</a></li>
                </ul>
            </div>
        </nav>
    </header>
    <section class="bg-[#243668] h-full lg:h-screen bg-repeat bg-contain lg:bg-no-repeat lg:bg-cover" style="background-image: url({{ asset('images/webp/probar2.webp') }})">
        ...
        <div class="lg:container mx-auto md:flex gap-5 md:w-full px-3 h-[400px] lg:h-screen">
            <div class="animate__animated animate__backInLeft lg:left w-6/6 lg:w-2/3 max-auto pt-10 text-center lg:text-left lg:pl-10 m-auto mt-1 lg:mt-auto">
                <span class="bg-[#88D3F2] rounded-md py-1 px-3 text-white font-bold text-sm uppercase">Bienvenidos a</span>
    ...
    <section id="sobreMi" class="bg-[#88D3F2] -scroll-mt-[10px]">
        <div class="h-3 bg-repeat-x relative z-50 -top-2" style="background-image: url({{ asset('images/wave-blue.png') }})"></div>
        <div class="text-center py-10">
            <h1 class="text-6xl font-black text-[#243668] animate__animated animate__bounce">Quien soy yo?</h1>
    ...
    <section id="Padres" class="bg-white -scroll-mt-[10px]">
        <div class="text-center py-10">
            <h1 class="text-6xl font-black text-[#243668] animate__animated animate__bounce">Mis Padres</h1>
            <h1 class="text-2xl font-black text-gray-600">(Información)</h1>
        </div>
        <div class="container mx-auto block md:flex gap-5 w-full px-3 pb-5 h-auto">
            ...
            <div class="text-center w-6/6 md:w-3/6 lg:w-2/6 max-auto">
                ...
                <div class="flex w-full gap-5 justify-center mt-5">
                    <a href="https://www.instagram.com/constanza_echebea" target="_blank" class="opacity-80 hover:opacity-100 hover:scale-110">
                        <svg class="h-12 w-12" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 64 64"><radialGradient id="TGwjmZMm2W~B4yrgup6jda" cx="32" cy="32.5" r="31.259" gradientTransform="matrix(1 0 0 -1 0 64)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#efdcb1"/><stop offset="0" stop-color="#f2e0bb"/><stop offset=".011" stop-color="#f2e0bc"/><stop offset=".362" stop-color="#f9edd2"/><stop offset=".699" stop-color="#fef4df"/><stop offset="1" stop-color="#fff7e4"/></radialGradient><path fill="url(#TGwjmZMm2W~B4yrgup6jda)" d="M58,54c-1.1,0-2-0.9-2-2s0.9-2,2-2h2.5c1.9,0,3.5-1.6,3.5-3.5S62.4,43,60.5,43H50c-1.4,0-2.5-1.1-2.5-2.5	S48.6,38,50,38h8c1.7,0,3-1.3,3-3s-1.3-3-3-3H42v-6h18c2.3,0,4.2-2,4-4.4c-0.2-2.1-2.1-3.6-4.2-3.6H58c-1.1,0-2-0.9-2-2s0.9-2,2-2	h0.4c1.3,0,2.5-0.9,2.6-2.2c0.2-1.5-1-2.8-2.5-2.8h-14C43.7,9,43,8.3,43,7.5S43.7,6,44.5,6h3.9c1.3,0,2.5-0.9,2.6-2.2	C51.1,2.3,50,1,48.5,1H15.6c-1.3,0-2.5,0.9-2.6,2.2C12.9,4.7,14,6,15.5,6H19c1.1,0,2,0.9,2,2s-0.9,2-2,2H6.2c-2.1,0-4,1.5-4.2,3.6	C1.8,16,3.7,18,6,18h2.5c1.9,0,3.5,1.6,3.5,3.5S10.4,25,8.5,25H5.2c-2.1,0-4,1.5-4.2,3.6C0.8,31,2.7,33,5,33h17v11H6	c-1.7,0-3,1.3-3,3s1.3,3,3,3l0,0c1.1,0,2,0.9,2,2s-0.9,2-2,2H4.2c-2.1,0-4,1.5-4.2,3.6C-0.2,60,1.7,62,4,62h53.8	c2.1,0,4-1.5,4.2-3.6C62.2,56,60.3,54,58,54z"/><radialGradient id="TGwjmZMm2W~B4yrgup6jdb" cx="18.51" cy="66.293" r="69.648" gradientTransform="matrix(.6435 -.7654 .5056 .4251 -26.92 52.282)" gradientUnits="userSpaceOnUse"><stop offset=".073" stop-color="#eacc7b"/><stop offset=".184" stop-color="#ecaa59"/><stop offset=".307" stop-color="#ef802e"/><stop offset=".358" stop-color="#ef6d3a"/><stop offset=".46" stop-color="#f04b50"/><stop offset=".516" stop-color="#f03e58"/><stop offset=".689" stop-color="#db359e"/><stop offset=".724" stop-color="#ce37a4"/><stop offset=".789" stop-color="#ac3cb4"/><stop offset=".877" stop-color="#7544cf"/><stop offset=".98" stop-color="#2b4ff2"/></radialGradient><path fill="url(#TGwjmZMm2W~B4yrgup6jdb)" d="M45,57H19c-5.5,0-10-4.5-10-10V21c0-5.5,4.5-10,10-10h26c5.5,0,10,4.5,10,10v26C55,52.5,50.5,57,45,57z"/><path fill="#fff" d="M32,20c4.6,0,5.1,0,6.9,0.1c1.7,0.1,2.6,0.4,3.2,0.6c0.8,0.3,1.4,0.7,2,1.3c0.6,0.6,1,1.2,1.3,2 c0.2,0.6,0.5,1.5,0.6,3.2C46,28.9,46,29.4,46,34s0,5.1-0.1,6.9c-0.1,1.7-0.4,2.6-0.6,3.2c-0.3,0.8-0.7,1.4-1.3,2 c-0.6,0.6-1.2,1-2,1.3c-0.6,0.2-1.5,0.5-3.2,0.6C37.1,48,36.6,48,32,48s-5.1,0-6.9-0.1c-1.7-0.1-2.6-0.4-3.2-0.6 c-0.8-0.3-1.4-0.7-2-1.3c-0.6-0.6-1-1.2-1.3-2c-0.2-0.6-0.5-1.5-0.6-3.2C18,39.1,18,38.6,18,34s0-5.1,0.1-6.9 c0.1-1.7,0.4-2.6,0.6-3.2c0.3-0.8,0.7-1.4,1.3-2c0.6-0.6,1.2-1,2-1.3c0.6-0.2,1.5-0.5,3.2-0.6C26.9,20,27.4,20,32,20 M32,17 c-4.6,0-5.2,0-7,0.1c-1.8,0.1-3,0.4-4.1,0.8c-1.1,0.4-2.1,1-3,2s-1.5,1.9-2,3c-0.4,1.1-0.7,2.3-0.8,4.1C15,28.8,15,29.4,15,34 s0,5.2,0.1,7c0.1,1.8,0.4,3,0.8,4.1c0.4,1.1,1,2.1,2,3c0.9,0.9,1.9,1.5,3,2c1.1,0.4,2.3,0.7,4.1,0.8c1.8,0.1,2.4,0.1,7,0.1 s5.2,0,7-0.1c1.8-0.1,3-0.4,4.1-0.8c1.1-0.4,2.1-1,3-2c0.9-0.9,1.5-1.9,2-3c0.4-1.1,0.7-2.3,0.8-4.1c0.1-1.8,0.1-2.4,0.1-7 s0-5.2-0.1-7c-0.1-1.8-0.4-3-0.8-4.1c-0.4-1.1-1-2.1-2-3s-1.9-1.5-3-2c-1.1-0.4-2.3-0.7-4.1-0.8C37.2,17,36.6,17,32,17L32,17z"/><path fill="#fff" d="M32,25c-5,0-9,4-9,9s4,9,9,9s9-4,9-9S37,25,32,25z M32,40c-3.3,0-6-2.7-6-6s2.7-6,6-6s6,2.7,6,6S35.3,40,32,40 z"/><circle cx="41" cy="25" r="2" fill="#fff"/></svg>
                    </a>
                </div>
            </div>
    ...
    <section id="BabyShower" class="bg-[#243668] bg-repeat-x bg-contain -scroll-mt-[10px]" style="background-image: url({{ asset('images/webp/g9.webp') }})" >
        ...
        <div class="text-center py-10 items-center justify-items-center">
            ...
            <h1 class="pt-2 text-2xl font-black text-gray-600">(Evento)</h1>
        </div>
        ...
        <div class="bg-[#88D3F2] rounded-lg md:rounded-full mx-[20px] lg:mx-[100px] mb-[20px] p-[20px] hover:scale-110 duration-200">
            <h1 class="text-lg lg:text-2xl font-black text-white text-center">Te esperamos este <b class="text-[#FFE288]">4</b> de <b class="text-[#FFE288]">junio</b> del 2022 a las <b class="text-[#FFE288]">19:00</b> PM hrs</h1>
            <h1 class="text-lg lg:text-3xl font-black text-white text-center"><b class="text-[#243668]">Club de Campo, Hualles N°2925, Arica</b></h1>
            <h1 class="text-lg lg:text-2xl font-black text-white text-center">ingreso solo con <b class="text-red-400">carnet en mano</b></h1>
        </div>
        <div class="h-3 bg-repeat-x relative z-50 rotate-180 -bottom-2" style="background-image: url({{ asset('images/wave-dblue.png') }})"></div>
    </section>

    <section id="Fotos" class="bg-[#FFE288]  -scroll-mt-[10px]">
        <div class="text-center py-10">
            <h1 class="text-6xl font-black">Work in Progress</h1>
            <h1 class="text-2xl font-black text-gray-600">(Fotos)</h1>
        </div>
        <div class="h-3 bg-repeat-x relative z-50 rotate-180 -bottom-2" style="background-image: url({{ asset('images/wave-yellow.png') }})"></div>
    </section>

    <footer id="Contacto" class="bg-[#88D3F2] pt-4 pb-4 pt-4 pb-4">
        <div class="mx-auto mt-3 text-center">
            <div class="grid grid-cols-6 gap-2 my-2">
                ...
                <div class="col-span-6 md:col-span-2">
                    <div class="grid grid-rows-2 flex justify-center items-center py-1 md:py-4">
                        <div class="grid-cols-1">
                            <div class="flex w-full gap-3">
                                <a href="https://www.instagram.com/andrw_cl" target="_blank" style="border-width: 0;" aria-label="Instagram Papá" class="w-16 h-16 rounded flex justify-center items-center bg-transparent cursor-pointer hover:bg-[#FFE288]">
                                    <svg class="h-8 w-8" viewBox="0 0 512 512">
                                        <circle style="fill:#243668;" cx="256" cy="256" r="256"/>
                                        <path style="fill:#243668;" d="M256,0c-11.317,0-22.461,0.744-33.391,2.167C348.216,18.53,445.217,125.933,445.217,256 s-97.002,237.47-222.609,253.833C233.539,511.256,244.683,512,256,512c141.385,0,256-114.616,256-256S397.385,0,256,0z"/>
                                        <g>
                                ...
                                <a href="https://www.instagram.com/constanza_echebea" target="_blank" style="border-width: 0;" aria-label="Instagram Mamá" class="w-16 h-16 rounded flex justify-center items-center bg-transparent cursor-pointer hover:bg-[#FFE288]">
                                    <svg class="h-8 w-8" viewBox="0 0 512 512">
                                ...
                                <a href="https://github.com/fairstyle" target="_blank" style="border-width: 0;" aria-label="Github" class="w-16 h-16 rounded flex justify-center items-center bg-transparent cursor-pointer hover:bg-[#FFE288]">
                                    <svg class="h-8 w-8" viewBox="0 0 496 496">
                                        <path id="SVGCleanerId_0" style="fill:#111827;" d="M247.992,5.163C111.048,5.163,0,116.627,0,254.163
                                        ...
                                        <g>
                                            <path id="SVGCleanerId_0_1_" style="fill:#111827;" d="M247.992,5.163C111.048,5.163,0,116.627,0,254.163
                                                c0,109.992,71.048,203.32,169.632,236.24c12.392,2.296,16.912-5.392,16.912-12c0-5.904-0.216-21.56-0.336-42.344
                                                c-69,15.064-83.552-33.376-83.552-33.376c-11.264-28.768-27.52-36.408-27.52-36.408c-22.528-15.456,1.696-15.16,1.696-15.16
                                                c24.88,1.752,37.976,25.672,37.976,25.672c22.144,38.048,58.064,27.048,72.192,20.672c2.232-16.08,8.656-27.064,15.736-33.28
                                                c-55.056-6.296-112.944-27.64-112.944-123.04c0-27.176,9.656-49.408,25.52-66.832c-2.568-6.296-11.072-31.6,2.416-65.872
                                        ...
                                        <g>
                                            <path style="fill:#1C2842;" d="M378.496,109.131c13.128,33.904,4.752,58.928,2.2,65.176c15.904,17.424,25.504,39.648,25.504,66.832
                                            c0,95.64-57.984,116.68-113.232,122.856c8.904,7.688,16.832,22.872,16.832,46.112c0,33.296-0.296,60.128-0.296,68.296
                                            ...
                                            <path style="fill:#1C2842;" d="M192.976,377.323c2.784-5.616,6.184-9.984,9.76-13.144c-30.176-3.456-61.168-11.512-83.048-33.744
                                            C136.52,358.451,163.928,371.195,192.976,377.323z"/>
                                        </g>
                                        <path style="fill:#111827;" d="M12.912,270.947c0-137.536,111.048-249,247.992-249c76.04,0,144.056,34.392,189.536,88.488
                                        ...
                                        <path style="fill:#111827;" d="M322.712,426.899c0-23.232-7.928-38.44-16.832-46.128c55.248-6.16,113.24-27.216,113.24-122.848
                                        ...
                                        <path style="fill:#111827;" d="M117.464,423.995c5.208,10.72,22.712,36.4,68.888,30.992c-0.064-5.648-0.112-11.976-0.144-18.928
                                            C150.584,443.835,129.552,434.667,117.464,423.995z"/>
                                        <path style="fill:#111827;" d="M126.368,391.387c-1.592-2.4-4.576-6.472-8.904-10.544
                        ...
                        <div class="grid-cols-1">
                            <span class="text-[#243668] font-bold">Made in Chile with <b class="text-red-500">❤</b></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function initMap() {
            ...
            const uluru = { lat: -18.4921722, lng: -70.2860676 };
